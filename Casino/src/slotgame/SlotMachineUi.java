...
public class SlotMachineUi {
	...
	public SlotMachineUi(int credits, int boughtCredits, int bet, double payout, double creditBuyout, int reel1, int reel2, int reel3) {
	...
	private void createForm() {
		...
		pnlReel3 = new JPanel();
		pnlReel3.setBackground(new Color(255, 215, 0));
	...
	public void buyCreditsCheck() {
		if (funds < bet) {
			...
			btnCash.setBackground(new Color(50, 255, 50));
		}
	}
	...
	class SpinHandler implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			if (funds < creditBuyout && credits < bet) {
				...
				pnlReel1.setBackground(new Color(255, 215, 0));
				pnlReel2.setBackground(new Color(255, 215, 0));
				pnlReel3.setBackground(new Color(255, 215, 0));
				genReelNumbers();
				matchCheck();
			} else {
	...
	public void matchCheck() {
		if (reel1 == reel2 && reel2 == reel3) {
			...
			pnlReel1.setBackground(new Color(255, 0, 0)); // Highlights matched icons.
			pnlReel2.setBackground(new Color(255, 0, 0));
			pnlReel3.setBackground(new Color(255, 0, 0));
			...
			lblMatchTwo.setText("Matched Two: "+matchTwo());
			pnlReel2.setBackground(new Color(255, 0, 0)); // Highlights matched icons.
			pnlReel3.setBackground(new Color(255, 0, 0));
		} else {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SlotMachineUi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
